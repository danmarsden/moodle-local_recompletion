...
/**
 * Quiz attempts archive datasource.
 *
...
class archived_quiz_atempts extends datasource {
    ...
    public static function get_name(): string {
        return get_string('datasource:local_recompletion_qa', 'local_recompletion');
    }
    ...
    protected function initialise(): void {
        $quizgrades = new quiz_attempts();
        $quizgradesalias = $quizgrades->get_table_alias('local_recompletion_qa');
        $this->add_entity($quizgrades);

        $this->set_main_table('local_recompletion_qa', $quizgradesalias);
