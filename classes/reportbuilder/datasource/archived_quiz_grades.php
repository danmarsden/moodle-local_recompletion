...
/**
 * Quiz grades archive datasource.
 *
...
class archived_quiz_grades extends datasource {
    ...
    protected function initialise(): void {
        ...
        $quizgradesalias = $quizgrades->get_table_alias('local_recompletion_qg');
        $this->add_entity($quizgrades);

        $this->set_main_table('local_recompletion_qg', $quizgradesalias);
