...
$string['restrictedbygroup'] = 'Resetting completion for a given user is restricted by course group';
...
$string['restrictgroups'] = 'Groups';
$string['restrictgroups_help'] = 'Only users who are members of one of the selected groups will be included in resetting completion data. If none selected, that means no restrictions by group for users.';
