...
$string['activitycompletiondate'] = 'Activity Date Completed';
...
$string['archiveassign'] = 'Archive assignment submissions and grades';
...
If delete is selected, assignment submissions and grades will be deleted for the selected user.
If archive is selected, assignment submissions and grades will be archived in the local_recompletion_as and local_recompletion_ag tables before deletion.
...
$string['datasource:local_recompletion_ssv'] = 'Archive of SCORM tracking values';
...
$string['entity:local_recompletion_ssv'] = 'Archive of SCORM tracking values';
$string['entityactivitycompletion'] = 'Entity activity completion';
$string['entityusergroup'] = 'Entity user group';
$string['eventcoursecompletionupdated'] = 'Course completion date updated';
$string['eventrecompletion'] = 'Course recompletion';
$string['eventrecompletionfailed'] = 'Course recompletion failed';
...
$string['privacy:metadata:assignment'] = 'The assignment ID linked to this table.';
$string['privacy:metadata:attemptnumber'] = 'The attempt number that this record relates to.';
$string['privacy:metadata:groupid'] = 'The group ID linked to this record.';
$string['privacy:metadata:grader'] = 'The user ID of the grader.';
$string['privacy:metadata:latest'] = 'Whether this is the latest attempt.';
$string['privacy:metadata:status'] = 'The submission status.';
$string['privacy:metadata:penalty'] = 'The penalty applied to this grade.';
...
$string['privacy:metadata:local_recompletion_as'] = 'Archive of assignment submissions.';
$string['privacy:metadata:local_recompletion_ag'] = 'Archive of assignment grades.';
$string['privacy:metadata:local_recompletion_as:assignment'] = 'The assignment this submission belongs to.';
$string['privacy:metadata:local_recompletion_as:course'] = 'The course this submission belongs to.';
$string['privacy:metadata:local_recompletion_as:latest'] = 'If this is the latest submission.';
$string['privacy:metadata:local_recompletion_as:status'] = 'The submission status.';
$string['privacy:metadata:local_recompletion_as:timestarted'] = 'The time the submission was started.';
$string['privacy:metadata:local_recompletion_ag:assignment'] = 'The assignment this grade belongs to.';
$string['privacy:metadata:local_recompletion_ag:course'] = 'The course this grade belongs to.';
$string['privacy:metadata:local_recompletion_ag:grader'] = 'The user who graded the submission.';
$string['privacy:metadata:local_recompletion_ag:grade'] = 'The grade awarded for the submission.';
$string['privacy:metadata:local_recompletion_ag:penalty'] = 'The penalty applied to the grade.';
$string['privacy:metadata:local_recompletion_ag:attemptnumber'] = 'The attempt number for this grade.';
$string['entity:local_recompletion_as'] = 'Archived assignment submissions';
$string['entity:local_recompletion_ag'] = 'Archived assignment grades';
$string['assignsubmissionstatus'] = 'Submission status';
$string['assignattemptnumber'] = 'Attempt number';
$string['assigngrade'] = 'Grade';
$string['assignpenalty'] = 'Penalty';
$string['assignsubmissionlatest'] = 'Latest submission';
$string['assignsubmissiontimestarted'] = 'Submission started';
$string['datasource:local_recompletion_as'] = 'Archived assignment submissions and grades';
